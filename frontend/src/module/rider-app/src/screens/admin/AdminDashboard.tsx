...
export const AdminDashboard: React.FC = () => {
  ...
  const vehicles: Vehicle[] = [
    { id: '1', name: 'Revolt RV400', type: 'bike', pricePerDay: 450, location: 'Downtown Station', rating: 4.8, reviews: 234, image: 'https://images.unsplash.com/photo-1558981403-c5f9899a28bc?w=600&h=400&fit=crop', available: 5, total: 10, bookings: 156, coords: { x: 45, y: 30 }, batteryLevel: 85, range: 120, chargePort: 'Type 2' },
    { id: '2', name: 'Ola S1 Pro', type: 'scooter', pricePerDay: 300, location: 'Mall Parking', rating: 4.9, reviews: 489, image: 'https://cdn.bikedekho.com/processedimages/ola-electric/2025-s1-pro/source/2025-s1-pro679ce0d5bd70a.jpg', available: 12, total: 15, bookings: 142, coords: { x: 75, y: 55 }, batteryLevel: 92, range: 135, chargePort: 'Portable' },
    { id: '3', name: 'Ather 450X', type: 'scooter', pricePerDay: 350, location: 'Airport Station', rating: 4.9, reviews: 456, image: 'https://cdn.bikedekho.com/processedimages/ola-electric/2025-s1-pro/source/2025-s1-pro679ce0d5bd70a.jpg', available: 8, total: 8, bookings: 89, coords: { x: 20, y: 25 }, batteryLevel: 68, range: 105, chargePort: 'Fast Charge' },
    { id: '4', name: 'Ultraviolette F77', type: 'bike', pricePerDay: 850, location: 'City Center', rating: 4.7, reviews: 123, image: 'https://images.unsplash.com/photo-1558981403-c5f9899a28bc?w=600&h=400&fit=crop', available: 2, total: 20, bookings: 176, coords: { x: 50, y: 70 }, batteryLevel: 100, range: 307, chargePort: 'CCS2' },
    { id: '5', name: 'Tata Nexon EV', type: 'car', pricePerDay: 1500, location: 'Central Hub', rating: 4.8, reviews: 512, image: 'https://images.unsplash.com/photo-1593941707882-a5bba14938c7?auto=format&fit=crop&q=80&w=400', available: 6, total: 6, bookings: 98, coords: { x: 60, y: 40 }, batteryLevel: 78, range: 312, chargePort: 'CCS2' },
    { id: '6', name: 'MG ZS EV', type: 'car', pricePerDay: 1800, location: 'Downtown Station', rating: 4.7, reviews: 267, image: 'https://images.unsplash.com/photo-1593941707882-a5bba14938c7?auto=format&fit=crop&q=80&w=400', available: 4, total: 12, bookings: 156, coords: { x: 30, y: 65 }, batteryLevel: 54, range: 280, chargePort: 'CCS2' },
    { id: '7', name: 'BYD Atto 3', type: 'car', pricePerDay: 2200, location: 'Airport Station', rating: 4.9, reviews: 189, image: 'https://images.unsplash.com/photo-1593941707882-a5bba14938c7?auto=format&fit=crop&q=80&w=400', available: 2, total: 4, bookings: 67, coords: { x: 80, y: 20 }, batteryLevel: 95, range: 480, chargePort: 'CCS2' },
    { id: '8', name: 'EcoBike (Accessible)', type: 'bike', pricePerDay: 300, location: 'Accessible Hub', rating: 4.7, reviews: 142, image: 'https://images.unsplash.com/photo-1558981403-c5f9899a28bc?w=600&h=400&fit=crop', available: 6, total: 10, bookings: 84, handicap: true, coords: { x: 40, y: 50 }, batteryLevel: 80, range: 90, chargePort: 'Standard' },
    { id: '9', name: 'EcoScoot (Accessible)', type: 'scooter', pricePerDay: 250, location: 'Accessible Hub', rating: 4.6, reviews: 98, image: 'https://cdn.bikedekho.com/processedimages/ola-electric/2025-s1-pro/source/2025-s1-pro679ce0d5bd70a.jpg', available: 10, total: 15, bookings: 112, handicap: true, coords: { x: 65, y: 35 }, batteryLevel: 45, range: 60, chargePort: 'Standard' },
  ];
